...
#include "coll-aoc-runner/math/Math.hpp"
...
long long calculateCode(int row, int col)
{
	...
	return (static_cast<long long>(20151125) * caoc::math::modExp(static_cast<long long>(252533), index - 1, static_cast<long long>(33554393))) % 33554393;
}
